...
import { authQueryOptions, type AuthQueryResult } from "@chessu/auth/tanstack/queries";
import appCss from "~/styles.css?url";

import { Toaster } from "@chessu/ui/components/sonner";
import { ThemeProvider } from "@chessu/ui/lib/theme-provider";
...
export const Route = createRootRouteWithContext<{
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Play chess online with friends and AI opponents.",
      },
    ],
